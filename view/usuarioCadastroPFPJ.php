                ...
                <nav class="navbar">
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            ...
                            <center>
                                <div class="botoes">
                                    <a href="usuarioViewCadastroPessoaJuridicaNew.php" class="btn btn-large btn-primary float-left"
                                    style="float:left: ;">Pessoa Juridica</a>
                                    <a href="usuarioViewCadastroPessoaFisicaNew.php" class="btn btn-large btn-primary float-left"
