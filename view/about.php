		...
		<div class="container divDimensoes">
			...
			<div class="row">
				<div class="box">
					<div class="col-lg-12">
						<hr>
						<h2 class="intro-text text-center">Sobre<strong> SysTransportes</strong></h2>
						<hr>
					</div>
					<div class="col-md-6">
			...
			<div class="row">
				<div class="box">
					<div class="col-lg-12">
						<hr>
						<h2 class="intro-text text-center">Nossa<strong> Equipe</strong></h2>
						<hr>
					</div>
					<div class="col-sm-4 text-center">
						<img class="img-responsive" src="../img/PessoaUm.jpg" alt="">
						<h3>Ramos Tavares <small>Dretor</small></h3>
					</div>
					<div class="col-sm-4 text-center">
						<img class="img-responsive" src="../img/PessoaDois.jpg" alt="">
						<h3>Amanda Rodrigues <small>Gerente Geral</small></h3>
					</div>
					<div class="col-sm-4 text-center">
						<img class="img-responsive" src="../img/PessoaTres.jpg" alt="">
						<h3>Felipe Coutinho <small>Supervisor</small></h3>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
