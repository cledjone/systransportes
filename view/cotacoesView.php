<html>
	...
	<body>
			...
			<center>
				<table>
					<tr>
						...
						<table style="border: 1px solid;">
							<tr>
								<td colspan="2" style="border: 1px solid;"><b><font size="3" color="red">ORIGEM</font></b></td>
							</tr>
							<tr>
								<td>UF</td>
								<td>Cidade</td>
						...
						<table style="border: 1px solid;">
							<tr>
								<td colspan="2"  style="border: 1px solid;"><b><font size="3" color="red">DESTINO</font></b></td>
							</tr>
							<tr>
								<td>UF</td>
								<td>Cidade</td>
				...
				<table style="border: 1px solid;">
					<tr>
						...
						<center>
							<font color="red" size="4">DADOS DA CARGA:</font>
						</center></td>
					</tr>
				...
				<center>
					<table style="border: 1px solid;">
						<tr>
							<td colspan="20" style="border: 1px solid;">
							<center>
								<font color="red" size="4">TOTAL:</font>
							</center></td>
						</tr>
		...
		<table align="center">
		<tr>
		<td id="acaoCliente" colspan="2"></td>
		</tr>
		<tr>
		<td  colspan="2"> &nbsp; </td>
		</tr>
								...
								<tr>
									...
									<table border="1" width="100%">
										<tr>
											<td width="220">
											<center>
												<font color="green">CIDADE ORIGEM:</font>
											</center></td>
											<td width="220">
											<center>
												<font color="green" >CIDADE DESTINO:</font>
											</center></td>
											<td width="120">
											<center>
											...
											<td width="120">
											<center>
												<font color="green" >PESO:</font>
											</center></td>
											<td width="150">
											<center>
												<font color="green" >COMPRIMENTO:</font>
											</center></td>
											<td width="120">
											<center>
												<font color="green" >FRETE:</font>
											</center></td>
											<td width="80">
											<center>
												<font color="green" >PRAZO:</font>
											</center></td>
											<td width="120">
											<center>
