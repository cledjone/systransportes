<?php
  ...
  class CotacaoSql {  
     ...
     public static function adicionar(Cotacao $u) {
	  ...
	  $objCidadeOrigem = mysql_real_escape_string($u->getObjCidadeOrigem(), $conexao); 
	  $objCidadeDestino = mysql_real_escape_string($u->getObjCidadeDestino(), $conexao); 

	  $sql = "insert into cotacoes (idUsuario, codCidadeOrigem, codCidadeDestino, valorCarga, valorFrete, altura, largura, peso, comprimento, quantidadeCaixa) values ($idUsuario,$objCidadeOrigem,$objCidadeDestino, $valorCarga, $valorFrete, $altura, $largura, $peso, $comprimento, $quantidadeCaixas)";	 
