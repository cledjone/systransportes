...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Set-2015 às 01:02
...
INSERT INTO `cotacoes` (`id`, `idUsuario`, `codCidadeOrigem`, `codCidadeDestino`, `valorCarga`, `valorFrete`, `altura`, `largura`, `peso`, `comprimento`, `prazo`, `quantidadeCaixa`, `descricao`, `aprovadoCliente`, `aprovadoAtendente`, `status`) VALUES
(11, 1, 1300060, 2300408, 6, 0, 1, 2, 3, 4, 0, 5, 'nada', 0, 0, '1'),
(12, 1, 1099970, 2600401, 6, 0, 1, 2, 3, 4, 0, 5, 'nada', 1, 0, '1'),
(13, 1, 2604304, 2901601, 0.05, 0, 0, 0.01, 0.02, 0.03, 0, 4, 'nada', 0, 0, '0'),
(14, 1, 2100477, 1200401, 0.99, 0, 0.99, 0.99, 0.99, 0.99, 0, 99, 'nada', 0, 0, '1'),
(15, 1, 2600302, 4101507, 0.01, 30, 0.01, 0.01, 0.01, 0.01, 9, 1, '', NULL, NULL, '1');
...
--
-- Estrutura da tabela `manifestos`
--
...
INSERT INTO `perfils` (`id`, `descricao`) VALUES
(1, 'padrao');
...
INSERT INTO `usuarios` (`id`, `idPerfil`, `codCidade`, `nome`, `razaoSocial`, `fantasia`, `cpfcnpj`, `email`, `telefone1`, `telefone2`, `logradouro`, `bairro`, `cep`, `login`, `senha`) VALUES
(1, 1, 1100114, 'testando da silva', 'testador', 'testor', '1', '1', '1', '1', '1', '1', '1', 'master', '123');
...
ALTER TABLE `cotacoes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_cotacoes_usuarios` (`idUsuario`),
  ADD KEY `FK_cotacoes_cidades` (`codCidadeOrigem`),
  ADD KEY `FK_cotacoes_cidades_2` (`codCidadeDestino`);
...
ALTER TABLE `ctes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_ctes_cotacoes` (`idCotacao`),
  ADD KEY `FK_ctes_manifestos` (`idManifesto`),
  ADD KEY `FK_ctes_faturamentos` (`idFaturamento`),
  ADD KEY `FK_ctes_usuarios` (`idRemetente`),
  ADD KEY `FK_ctes_usuarios_2` (`idDestinatario`);

--
-- Indexes for table `faturamentos`
--
...
ALTER TABLE `manifestos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_manifestos_veiculos` (`placaVeiculo`),
  ADD KEY `FK_manifestos_usuarios` (`idUsuario`);
...
ALTER TABLE `rastreamentos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_rastreamentos_ctes` (`idCte`);
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_usuarios_perfils` (`idPerfil`),
  ADD KEY `FK_usuarios_cidades` (`codCidade`);
...
--
-- AUTO_INCREMENT for table `ctes`
--
ALTER TABLE `ctes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `faturamentos`
--
ALTER TABLE `faturamentos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `cotacoes`
  ADD CONSTRAINT `FK_cotacoes_cidades` FOREIGN KEY (`codCidadeOrigem`) REFERENCES `cidades` (`codigo`),
  ADD CONSTRAINT `FK_cotacoes_cidades_2` FOREIGN KEY (`codCidadeDestino`) REFERENCES `cidades` (`codigo`),
  ADD CONSTRAINT `FK_cotacoes_usuarios` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`id`);

--
-- Limitadores para a tabela `ctes`
--
ALTER TABLE `ctes`
  ADD CONSTRAINT `FK_ctes_cotacoes` FOREIGN KEY (`idCotacao`) REFERENCES `cotacoes` (`id`),
  ADD CONSTRAINT `FK_ctes_faturamentos` FOREIGN KEY (`idFaturamento`) REFERENCES `faturamentos` (`id`),
  ADD CONSTRAINT `FK_ctes_manifestos` FOREIGN KEY (`idManifesto`) REFERENCES `manifestos` (`id`),
  ADD CONSTRAINT `FK_ctes_usuarios` FOREIGN KEY (`idRemetente`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `FK_ctes_usuarios_2` FOREIGN KEY (`idDestinatario`) REFERENCES `usuarios` (`id`);

--
-- Limitadores para a tabela `manifestos`
--
ALTER TABLE `manifestos`
  ADD CONSTRAINT `FK_manifestos_usuarios` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `FK_manifestos_veiculos` FOREIGN KEY (`placaVeiculo`) REFERENCES `veiculos` (`placa`);

--
-- Limitadores para a tabela `rastreamentos`
--
ALTER TABLE `rastreamentos`
  ADD CONSTRAINT `FK_rastreamentos_ctes` FOREIGN KEY (`idCte`) REFERENCES `ctes` (`id`);

--
-- Limitadores para a tabela `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `FK_usuarios_cidades` FOREIGN KEY (`codCidade`) REFERENCES `cidades` (`codigo`),
  ADD CONSTRAINT `FK_usuarios_perfils` FOREIGN KEY (`idPerfil`) REFERENCES `perfils` (`id`);
